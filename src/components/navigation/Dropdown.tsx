...
export const DropDown = () => {
    ...
    return(
        <>
            <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" className="bg-amber-100 hover:bg-amber-200 font-black text-black rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center" type="button">Jerome <svg className="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
