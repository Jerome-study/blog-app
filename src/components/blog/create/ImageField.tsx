    ...
    return(
        <>
             <div className={`${selectedImage && "hidden"} border-4 relative rounded-2xl`}>
                <input type="file" accept="image/png, image/gif, image/jpeg" onChange={(e : any) => insertImage(e)}  className="cursor-pointer relative block opacity-0 w-full h-full p-20 z-10" />
